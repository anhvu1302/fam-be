...
public class SupplierMongo : BaseEntityMongo
{
    ...
    [BsonElement("contactPersonTitle")]
    public string? ContactPersonTitle { get; set; }

    // Account Manager
    [BsonElement("accountManagerName")]
    public string? AccountManagerName { get; set; }

    [BsonElement("accountManagerEmail")]
    public string? AccountManagerEmail { get; set; }

    [BsonElement("accountManagerPhone")]
    public string? AccountManagerPhone { get; set; }

    // Business Information
    [BsonElement("supplierType")]
    ...
    [BsonElement("taxExempt")]
    public bool TaxExempt { get; set; }

    [BsonElement("taxExemptCertificate")]
    ...
    [BsonElement("contractDocumentUrl")]
    ...
    // Shipping & Logistics
    [BsonElement("shippingMethods")]
    public string? ShippingMethods { get; set; }

    [BsonElement("shippingTerms")]
    public string? ShippingTerms { get; set; }

    [BsonElement("leadTimeDays")]
    public int? LeadTimeDays { get; set; }

    [BsonElement("minimumOrderValue")]
    public decimal? MinimumOrderValue { get; set; }

    [BsonElement("minimumOrderCurrency")]
    public string? MinimumOrderCurrency { get; set; }

    [BsonElement("dropShipCapable")]
    public bool DropShipCapable { get; set; }

    [BsonElement("warehouseLocations")]
    ...
    [BsonElement("slaDocumentUrl")]
    public string? SLADocumentUrl { get; set; }

    [BsonElement("provides24x7Support")]
    public bool Provides24x7Support { get; set; }

    // Insurance & Bonding
    [BsonElement("insuranceProvider")]
    public string? InsuranceProvider { get; set; }

    [BsonElement("insurancePolicyNumber")]
    public string? InsurancePolicyNumber { get; set; }

    [BsonElement("insuranceCoverage")]
    public decimal? InsuranceCoverage { get; set; }

    [BsonElement("insuranceExpiryDate")]
    public DateTime? InsuranceExpiryDate { get; set; }

    [BsonElement("bondingInformation")]
    ...
    [BsonElement("totalSpentCurrency")]
