...
public class UserDeviceMongo : BasicAuditedEntityMongoGuid
{
    ...
    [BsonElement("deviceType")] public string DeviceType { get; set; } = string.Empty;
    ...
    [BsonElement("browser")] public string? Browser { get; set; }
    ...
    [BsonElement("lastActivityAt")] public DateTime? LastActivityAt { get; set; }

    [BsonElement("isActive")] public bool IsActive { get; set; } = true;

    [BsonElement("isTrusted")] public bool IsTrusted { get; set; }

    [BsonElement("refreshToken")] public string? RefreshToken { get; set; }

    [BsonElement("refreshTokenExpiresAt")] public DateTime? RefreshTokenExpiresAt { get; set; }
