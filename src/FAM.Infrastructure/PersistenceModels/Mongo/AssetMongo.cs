...
public class AssetMongo : BaseEntityMongo
{
    ...
    // Status
    [BsonElement("usageStatusId")]
    public long? UsageStatusId { get; set; }

    [BsonElement("lifecycleStatusId")]
    ...
    [BsonElement("assetEventIds")]
    public List<long> AssetEventIds { get; set; } = new();

    [BsonElement("attachmentIds")]
    public List<long> AttachmentIds { get; set; } = new();

    [BsonElement("financeEntryIds")]
    public List<long> FinanceEntryIds { get; set; } = new();
