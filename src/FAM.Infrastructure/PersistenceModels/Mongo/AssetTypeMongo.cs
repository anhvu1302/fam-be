...
public class AssetTypeMongo : BaseEntityMongo
{
    ...
    // Classification
    [BsonElement("assetClass")] public string? AssetClass { get; set; }

    [BsonElement("category")] public string? Category { get; set; }

    [BsonElement("subcategory")] public string? Subcategory { get; set; }

    // Properties & Characteristics
    [BsonElement("isDepreciable")] public bool IsDepreciable { get; set; } = true;

    [BsonElement("isAssignable")] public bool IsAssignable { get; set; } = true;

    [BsonElement("isTangible")] public bool IsTangible { get; set; } = true;

    [BsonElement("isConsumable")] public bool IsConsumable { get; set; }

    [BsonElement("isCapitalized")] public bool IsCapitalized { get; set; } = true;

    [BsonElement("requiresLicense")] public bool RequiresLicense { get; set; }

    [BsonElement("requiresMaintenance")] public bool RequiresMaintenance { get; set; } = true;

    [BsonElement("requiresCalibration")] public bool RequiresCalibration { get; set; }

    [BsonElement("requiresInsurance")] public bool RequiresInsurance { get; set; }

    [BsonElement("isITAsset")] public bool IsITAsset { get; set; }
    ...
    [BsonElement("assetAccountCode")] public string? AssetAccountCode { get; set; }

    [BsonElement("expenseAccountCode")] public string? ExpenseAccountCode { get; set; }

    [BsonElement("costCenter")] public string? CostCenter { get; set; }

    // Lifecycle
    [BsonElement("defaultWarrantyMonths")] public int? DefaultWarrantyMonths { get; set; }
    ...
    [BsonElement("valuationCurrency")] public string? ValuationCurrency { get; set; }
    ...
    [BsonElement("requiresAccessControl")] public bool RequiresAccessControl { get; set; }
    ...
    [BsonElement("approvalWorkflow")] public string? ApprovalWorkflow { get; set; }

    // Custom Fields Definition
    [BsonElement("customFieldsSchema")] public string? CustomFieldsSchema { get; set; }

    [BsonElement("requiredFields")] public string? RequiredFields { get; set; }
    ...
    [BsonElement("isSystemType")] public bool IsSystemType { get; set; }

    [BsonElement("effectiveDate")] public DateTime? EffectiveDate { get; set; }
    ...
    [BsonIgnore] public AssetTypeMongo? Parent { get; set; }

    [BsonIgnore] public List<AssetTypeMongo> Children { get; set; } = new();
