        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    temp_key = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    ...
                    final_key = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "ix_upload_sessions_created_at",
                table: "upload_sessions",
                column: "created_at");

            migrationBuilder.CreateIndex(
                name: "ix_upload_sessions_entity",
                table: "upload_sessions",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_upload_sessions_idempotency_key",
                table: "upload_sessions",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_upload_sessions_upload_id",
                table: "upload_sessions",
                column: "upload_id",
                unique: true);
