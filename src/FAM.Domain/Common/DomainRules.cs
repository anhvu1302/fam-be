...
public static class DomainRules
{
    ...
    public static class Password
    {
        ...
        public static bool HasUppercase(string password) 
            => System.Text.RegularExpressions.Regex.IsMatch(password, UppercasePattern);
        
        /// <summary>
        /// Validates if password contains at least one lowercase letter
        /// </summary>
        public static bool HasLowercase(string password) 
            => System.Text.RegularExpressions.Regex.IsMatch(password, LowercasePattern);
        
        /// <summary>
        /// Validates if password contains at least one digit
        /// </summary>
        public static bool HasDigit(string password) 
            => System.Text.RegularExpressions.Regex.IsMatch(password, DigitPattern);
        
        /// <summary>
        /// Validates if password contains at least one special character
        /// </summary>
        public static bool HasSpecialChar(string password) 
            => System.Text.RegularExpressions.Regex.IsMatch(password, SpecialCharPattern);
    ...
    public static class DomainName
    {
        ...
        public const string Pattern = @"^(?:[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?\.)*[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?$";
