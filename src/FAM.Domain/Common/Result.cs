...
public class Result
{
    ...
    /// </summary>
    public static Result Failure(string errorCode) => new(false, new Error(errorCode));
    ...
    public static Result Failure(string errorCode, IDictionary<string, object> details) 
        => new(false, new Error(errorCode, details));
    ...
    /// </summary>
    public static Result<T> Failure<T>(string errorCode) => new(default!, false, new Error(errorCode));
    ...
    public static Result<T> Failure<T>(string errorCode, IDictionary<string, object> details) 
        => new(default!, false, new Error(errorCode, details));
