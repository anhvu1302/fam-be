...
public class PhoneNumberTests
{
    ...
    public void Create_WithValidPhoneNumber_ShouldCreatePhoneNumber()
    {
        ...
        // Act
        PhoneNumber phone = PhoneNumber.Create(phoneNumber, countryCode);
    ...
    {
        // Arrange
        string phoneNumber = "091 234 5678";
        string countryCode = "+84";
    ...
    {
        // Arrange
        string phoneNumber = "12345678"; // 8 digits
        string countryCode = "+84";
    ...
    {
        // Arrange
        string phoneNumber = "123456789012345"; // 15 digits
        string countryCode = "+84";
    ...
    public void Create_WithNullCountryCode_ShouldUseDefault()
    {
        ...
        // Act
        PhoneNumber phone = PhoneNumber.Create(phoneNumber, null);
    ...
    {
        // Arrange
        PhoneNumber phone1 = PhoneNumber.Create("0912345678", "+84");
        PhoneNumber phone2 = PhoneNumber.Create("0912345678", "+84");
    ...
    public void Equality_WithDifferentPhoneNumbers_ShouldNotBeEqual()
    {
        // Arrange
        PhoneNumber phone1 = PhoneNumber.Create("0912345678", "+84");
        PhoneNumber phone2 = PhoneNumber.Create("0912345679", "+84");
    ...
    public void Equality_WithDifferentCountryCodes_ShouldNotBeEqual()
    {
        // Arrange
        PhoneNumber phone1 = PhoneNumber.Create("0912345678", "+84");
        PhoneNumber phone2 = PhoneNumber.Create("0912345678", "+1");
    ...
    {
        // Arrange
        PhoneNumber phone = PhoneNumber.Create("0912345678", "+84");
    ...
    {
        // Arrange
        PhoneNumber phone = PhoneNumber.Create("0912345678", null);
    ...
    {
        // Arrange
        PhoneNumber phone = PhoneNumber.Create("0912345678");

        // Act
        string result = phone.ToFormattedString();
    ...
    {
        // Arrange
        PhoneNumber phone = PhoneNumber.Create("091234567"); // 9 digits, doesn't start with 0
