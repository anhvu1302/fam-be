...
public class UserNodeRoleTests
{
    ...
    {
        // Arrange
        User user = User.CreateWithPlainPassword("testuser", "test@example.com", "MySecurePass123!");
        ...
        // Act
        UserNodeRole userNodeRole = UserNodeRole.Create(user, node, role, startAt, endAt);
